...
export class CountrywiseStatComponent implements OnInit {
  ...
  @Input() countryStat: CountryCases;
  ...
  ngOnInit() {
    this.dataSource = new MatTableDataSource<CountryStat>(this.countryStat.countries_stat);
    this.dataSource.paginator = this.paginator;
    this.data = this.countryStat.countries_stat;
  }
}
